...
(
	CustomerNumber VARCHAR(8) NOT NULL CONSTRAINT PK_CustomerNumber PRIMARY KEY DEFAULT FORMAT((NEXT VALUE FOR Customer_Seq),'C0000#'),
...
(
	...
	ProductID VARCHAR(8) CONSTRAINT PK_ProductID PRIMARY KEY DEFAULT FORMAT((NEXT VALUE FOR Products_Seq),'P0000#'),
...
CREATE TABLE Policy
(
	PolicyID VARCHAR(8) CONSTRAINT PK_PolicyID PRIMARY KEY DEFAULT FORMAT((NEXT VALUE FOR Policy_Seq),'PLC0000#'),
